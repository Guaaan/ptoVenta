...
namespace ptoVenta
{
    public partial class iniciarSesion : Form
    {
        ...
        public void llenacombobox()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM USUARIOS ORDER BY NOMBRE", cn);
            da.Fill(ds, "USUARIOS");
        ...
        private void txtRut1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == 13)
            {
                ...
                else
                {
                    ...
                    com = new SqlCommand("SELECT TOP 1 * FROM USUARIOS WHERE CODIGO = '" + vuser + "' AND DPTO ='" + vclave + "' ", cn);
                    com.ExecuteNonQuery();
